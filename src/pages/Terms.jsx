  ...
  return (
    <div className="legal-page">
      ...
      <main className="legal-page__content">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Intellectual Property</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Service Modifications</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Data and Security</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Third-Party Services</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Internet Connection and Data Usage</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Device Responsibility</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Service Accuracy</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Artificial Intelligence</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Application Updates and Termination</h2>
          <p className="legal-page__text">
        ...
        <div className="legal-page__section">
          <h2 className="legal-page__section-title">Changes to These Terms and Conditions</h2>
          <p className="legal-page__text">
            The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms and Conditions on this page.
          </p>
          <p className="legal-page__text">
            These terms and conditions are effective as of 2025-12-08
          </p>
        </div>
